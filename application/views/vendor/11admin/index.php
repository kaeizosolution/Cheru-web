...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6"> <h3><?= $page_lang->admin; ?></h3> </div> <?= $breadcrumbs ?>
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
					 ...
					 <button onclick="window.location.href = '<?php echo base_url();?>admin/admin/export_csv';" type="button" class="btn btn-info"><i class="fa fa-cloud-download"></i><i class="" aria-hidden="true"></i> Export(CSV)</button>
