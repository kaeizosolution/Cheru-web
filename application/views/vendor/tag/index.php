<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6"><h3>Tag</h3> </div> <?= $breadcrumbs ?>
            </div>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <form id="filter_data" method="post">
                        <div class="row">
                            <div class="col-md-6 col s4">
								<label for="supplier_name">Tag name</label>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
     ...
     //   "order":[],
        ...
        "ajax": {
            "url": "<?= base_url().$TYPE; ?>/Tags/index_ajax_tag",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="<?php echo base_url().$TYPE; ?>/Tags/update/"+uid+"";
    url_new_tab(e,url);
} );
