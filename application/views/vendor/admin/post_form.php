    ...
    <div class="container-fluid">        
            ...
            <div class="row ">
                <div class="col-lg-12">
					...
					<ul class="nav 11nav-tabs profile-tab mb-2" role="tablist">
				...
				<form method="POST" class="addpost" id="postForm" action='<?php echo "/$TYPE/admin/$action/$admin_id"; ?>' enctype="multipart/form-data" autocomplete='off'>
                    ...
                    <div class="col-md-4 col-sm-12">
						<div class="mb-3 row">
						   ...
						   <div class="col-sm-12"> <a type="submit" class="btn btn-outline-primary btn-block" href="/vendor/admin">Back</a> </div>
						   <div class="col-sm-12 mt-2"> <button type="submit" id="confirm" class="btn btn-primary btn-block"><?= $page_lang->submit; ?></button> </div>
						...
						<div class="tab-pane" id="password1" role="tabpanel">
								...
								<div class="col-md-4 col-sm-12">
									<div class="mb-3 row">
										<input type="hidden" name="<?= $csrf->name; ?>" value="<?= $csrf->hash; ?>" />
									<div class="col-sm-12">
										<a type="submit" class="btn btn-outline-primary btn-block" href="/vendor/admin">Back</a>
									</div>
									<div class="col-sm-12 mt-2"><button id="confirm2" type="submit" class="btn btn-primary btn-block"><?= $page_lang->save; ?></button></div>
