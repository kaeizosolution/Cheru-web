                    ...
                    <div class="card"><div class="card-body">	
						...
						<div class="card-header customHeader">
							...
							<div class="mt-2 transactionBtn">								
								<a type="submit" class="btn btn-primary" href="/<?= $TYPE?>/categories_prod/add"><i class="fa fa-plus" aria-hidden="true"></i></a>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
     ...
     //   "order":[],
        ...
        "ajax": {
            "url": "<?= base_url().$TYPE; ?>/Categories_prod/index_ajax_cat",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="<?php echo base_url().$TYPE; ?>/categories_prod/update/"+uid+"";
    url_new_tab(e,url);
} );
