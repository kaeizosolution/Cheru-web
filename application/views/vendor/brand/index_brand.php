            ...
            <div class="col-sm-12">
                ...
                <div class="card">
					<div class="card-header customHeader">
						<h4 class="card-title"><?= $page_lang->brand; ?> List</h4>
						<div class=" mt-2 transactionBtn">
							<a type="submit" class="btn btn-primary" href="<?= base_url().$TYPE?>/brand/add"><i class="fa fa-plus" aria-hidden="true"></i></a>
            ...
            <div class="modal-body">
                <div class="col-sm-12 sp-top-30">
                    <form id="filter_data" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">                               
                                <button class="mt-4 btn btn-primary btnSubmit" type="button"><?= $page_lang->submit; ?></button>
                            </div>
                        </div>
                    </form>
                </div>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
     ...
     //   "order":[],
        ...
        "ajax": {
            "url": "<?= base_url().$TYPE; ?>/brand/index_ajax_brand",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
...
var actionTemplate = '<button title="Edit" data-toggle="tooltip" data-placement="top" data-animation="false" data-html="true" class="btn custom-popover-btn btn-edit btn btn-primary" type="button" data-id="'+row.brand_id+'"><i class="fa fa-pencil-square-o"></i></button>';
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="<?php echo base_url().$TYPE ?>/brand/update/"+uid+"";
    url_new_tab(e,url);
} );
