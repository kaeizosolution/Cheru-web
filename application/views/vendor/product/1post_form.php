                                ...
                                <div class="tab-content" id="v-pills-tabContent">
									...
									<div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="shipping_id" name="shipping_id" class="form-control shipping_combo">
                                                <?php
									...
									<div class="tab-pane fade container-fluid" id="v-pills-advanced" role="tabpanel" aria-labelledby="v-pills-advanced-tab">
                                        ...
                                        <div id="variations_data">
                                            <?php 
											if(isset($selected_variation_obj)) : foreach($selected_variation_obj as $k=>$v){ 
                                            ...
                                            <div class="border p-2 sadow m-t-10" style="background: #fbfbfb;" id="variation-<?php echo $variation_id; ?>">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7 col-md-7"><?= $page_lang->upoad_image; ?><input type="hidden" name="attr_itemid[]" class="attr_itemid" value="<?= $attribute_item_id ?>">
                                                        <input type="file" name="_thumbnail_id[]" id="_thumbnail_id_<?php echo $k; ?>" class="form-control" value="" <?= ($_thumbnail) ? '' : 'required' ?> data-parsley-filemaxsize="2040000000" data-parsley-fileextension="jpg|png|jpeg|webp" parsley-trigger="change" data-parsley-errors-container="#variation_file_error_<?=$attribute_item_id?>">
			...
			<div class="col-md-4 col-sm-12">
				<div class="basic-form">					
						<div class="mb-3 row">
							...
							<button type="button" class="btn btn-outline-primary btn-block"> <?= $page_lang->back; ?></button>
							
							</div>
							<div class="col-sm-12 mt-2">
							<button type="submit" class="btn btn-primary btn-block"><?= $page_lang->submit; ?></button>								
							</div>
						</div>				
				</div>	
			</div>
