            ...
            <div class="col-sm-12">
                <div class="card">    
                    <div class="card-body">
						...
						<a href="<?= base_url().$TYPE; ?>/supplier/add" class="btn btn-primary addNew" title="Add New" data-toggle="tooltip" data-placement="top" data-animation="false"><i class="fa fa-plus"></i></a>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url().$TYPE; ?>/supplier/index_ajax_post",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="<?php echo base_url().$TYPE; ?>/supplier/update/"+uid+"";
    url_new_tab(e,url);
} );
