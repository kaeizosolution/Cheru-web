                    ...
                    <div class="">
                      <div class="pdct-dts-1">
                        <div class="pdct-dt-step">
                          <h4>Description</h4>
                           <div class="delivery-dateby"> <?php if(isset($detail->post_content)){
                            echo nl2br(htmlspecialchars((string)$detail->post_content, ENT_QUOTES, 'UTF-8'));
                            }else{        
                              echo '<div class="alert alert-warning">No data available!</div>';
                            } ?></div>
                        </div>
          	...
          	<?php foreach($related_product as $v){?>
                ...
                <a href="<?= $v->url; ?>" class="product-img" title="post title"> <img src="<?= $v->featured_image ?>" alt="">
	                ...
	                <div class="product-text-dt">
	                   <h4><?= $v->post_title; ?></h4>
	                   <?php if($v->discount){ ?>
	                  <div class="product-price"><?= $v->symbol.'&nbsp;'.(int)$v->sale_price; ?><span class="line-through-price"><?= $v->symbol.(int)$v->regular_price; ?></span> <span class="product-off"><?=$detail->percentage_off?>% OFF</span></div>
	                  <?php } else {?>
