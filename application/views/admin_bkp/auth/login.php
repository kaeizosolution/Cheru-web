                ...
                <div class="col-md-8 p-0">
                    <div class="auth-innerright">
                        <div class="authentication-box">
                            ...
                            <?php } ?>
                                <?php echo form_open("/$TYPE/auth/login", array('id' => 'loginForm', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'theme-form')) ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="text-right mt-2 m-l-20">
                                                <a href="/<?= $TYPE?>/auth/forgot" class="btn-link text-capitalize">Forgot Password</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php echo form_close() ?>
