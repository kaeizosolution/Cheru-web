        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <div class="topAction-btn"><a href="/<?= $TYPE?>/tags_prod/add" class="btn btn-primary addNew" title="Add New" data-toggle="tooltip" data-placement="top" data-animation="false"><i class="fa fa-plus"></i></a>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
     ...
     //   "order":[],
        ...
        "ajax": {
            "url": "/<?= $TYPE; ?>/Tags_prod/index_ajax_tag",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="/<?php echo $TYPE ?>/Tags_prod/update/"+uid+"";
    url_new_tab(e,url);
} );
