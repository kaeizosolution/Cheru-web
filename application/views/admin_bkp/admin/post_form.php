<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
				<div class="col-lg-6"> <h3><?php echo $action.' user'; ?></h3> </div> <?= $breadcrumbs ?>
            </div>
        </div>
    </div>.
    <div class="container-fluid">
            ...
            <div class="row ">
                <div class="col-lg-12">
					...
					<ul class="nav nav-tabs profile-tab" role="tablist">
						...
						<?php if($admin_id){ ?>
						<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password1" role="tab" style="font-size: 14px;"> Change Passord</a> </li><?php } ?>
                        ...
                        <div class="row">							
							...
							<div class="col-sm-6 col-md-4">
								...
								<label class="form-label">Mobile </label>	 							
                                    <input type="text" name="mobile" class="form-control" id="mobile_no" value="<?= isset($mobile) ? $mobile : '' ?>" placeholder="Mobile"  maxlength="10">
							...
							<div class="form-group col-md-3">
								...
								<input type="password" name="password" id="new1" class="form-control" value="" required minlength="6"> 
							</div>
							<div class="form-group col-md-3">
								<label>Confirm Password</label>
								<input type="password" name="password2"  id="new2" value="" class="form-control " required > <span id="error" style="color:red;"></span>
							</div>
							<?php } ?>
							<!--<div class="form-group">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <button type="submit" id="confirm" class="btn btn-primary">Submit</button>
                    </div>
                    </form>
					</div></div></div></div>
							...
							<div class="card-body">  
								<form class="row" action="<?php echo "/$TYPE/admin/update_password/$admin_id"; ?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-actions col-md-12">
										<input type="hidden" name="<?= $csrf->name; ?>" value="<?= $csrf->hash; ?>" />
										<button id="confirm2" type="submit" class="btn btn-info"> <i class="fa fa-check"></i> Save</button>
