<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row"><div class="col-lg-6"> <h3>Customer</h3> </div>  <?= $breadcrumbs ?> </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
                    ...
                    <form id="filter_data" method="post">
                        <div class="row">
							...
							<div class="col-md-6 p-4">
								<div class="form-group">
									<label>Status</label>									
									<select class="form-control" id="status" name="enabled" required="required">	 		<option value="" selected>status</option>   
									<option value="1">Active</option>                          
									<option value="0">Inactive</option>   
									</select>
								</div>  
...
$(function () {
	$('.mydatetimepickerFull').daterangepicker({
	format: "yyyy-mm-dd"   
	});
});
*/
...
'<button title="'+row.status+'" data-toggle="tooltip" data-placement="top" data-animation="false" data-html="true" class="btn custom-popover-btn btn-status" type="button" data-status="'+row.status+'" data-id="'+row.customer_id+'"><i class="fa fa fa-toggle-on"></i></button>'+
'<button type="button" title="View" data-toggle="tooltip" class="btn custom-popover-btn btn-view" data-id="'+row.customer_id+'"><i class="fa fa-eye"></i></button>'+ 
'\''+
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="/<?php echo $TYPE ?>/user/update/"+uid+"";
    url_new_tab(e,url);
} );
...
$(document).on('click','.btn-view', function(e){
	...
	window.location.href = base_url+"/admin/user/view/"+uid;	
	//view_order(uid);
} );
