                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="profile" role="tabpanel">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="form-label">Title</label>
                                                    <input type="text" name="post_title_es"  class="form-control"  value="<?= isset($post_title_es) ? $post_title_es : '' ?>" placeholder="Enter Title" onkeypress="return check(event)">
                                                </div>
                                                <div class="form-group mb-0 m-t-10">
                                                    <label class="form-label">Body</label>
                                                    <textarea name="post_content_es" row="5" class="form-control" placeholder="Write Something..." ><?= isset($post_content_es) ? $post_content_es : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group col-md-6 m-t-20">
                                ...
                                if(isset($categories)){
                                    if(isset($category_ids)){
                                        echo form_dropdown('category[]',$categories,$category_ids,array('class' => 'select2 form-control category_combo','multiple' => true, 'required' => 'required', 'data-parsley-errors-container' => '#category_error'));   
                                    }else{
                                        echo form_dropdown('category[]',$categories,null,array('class' => 'select2 form-control category_combo','multiple' => true, 'required' => 'required', 'data-parsley-errors-container' => '#category_error'));
                                    } ?>
                                <?php } ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control status_combo" name="enabled" data-parsley-errors-container="#enabled_error" required="required">
                                        ...
                                        <?php if($product_id) { ?>
                                        <option value="1" <?= isset($enabled) && $enabled == 1 ? 'selected' : ''?>>Active</option>
                                        <?php }else { ?>
                                        <option value="1" selected>Active</option>
                                        <?php } ?>
                                        <option value="0" <?= isset($enabled) && $enabled == 0 ? 'selected' : ''?>>Inactive</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control featured_combo" name="featured_product" data-parsley-errors-container="#featured_product_error" required="required">
                                        <option value="">Select</option>
                                        <option value="1" <?= isset($featured_product) && $featured_product == 1 ? 'selected' : '' ?>>Yes</option>
                                        <?php if($product_id) { ?>
                                        <option value="0" <?= isset($featured_product) && $featured_product == 0 ? 'selected' : ''?>>No</option>
                                        <?php }else { ?>
                                    ...
                                    <span>
                                        ...
                                        <label for="product-type">
                                            <select id="type" name="type" class="form-control" <?= isset($product_id) ? 'disabled' : '' ?>>
                                                <option value="simple" <?= (isset($type) && $type == 'simple') ? 'selected' : '' ?>>Simple</option>
                                                <option value="variable" <?= (isset($type) && $type == 'variable') ? 'selected' : '' ?>>Variable</option>
                                            </select>
                        ...
                        <div class="card-body">
                            <div class="form-menu">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-file-text" aria-hidden="true"></i> <span>Price Range</span></a>
                                    <a class="nav-link" id="v-pills-simple-tab" data-toggle="pill" href="#v-pills-simple" role="tab" aria-controls="v-pills-simple" aria-selected="false" <?= (isset($type) && $type == 'simple') ? '' : 'style="display:none;"' ?>><i class="fa fa-cog" aria-hidden="true"></i> <span>Simple</span></a>
                                    <a class="nav-link" id="v-pills-advanced-tab" data-toggle="pill" href="#v-pills-advanced" role="tab" aria-controls="v-pills-advanced" aria-selected="false" <?= (isset($type) && $type == 'variable') ? '' : 'style="display:none;"' ?>><i class="fa fa-cog" aria-hidden="true"></i> <span>Variant</span></a>
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade container-fluid" id="v-pills-simple" role="tabpanel" aria-labelledby="v-pills-simple-tab">
                                        <div class="form-group row m-t-20 ">
                                            <label for="Stock quantity" class="col-sm-3 col-form-label">Stock</label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="tab-pane fade container-fluid" id="v-pills-advanced" role="tabpanel" aria-labelledby="v-pills-advanced-tab">
                                        <div class="row">
                                            ...
                                            <?php } ?>
                                            <div class="col-sm-2"><label>&nbsp;</label><a href="javascript:void(0);"class="btn btn-primary" id="variations_id">ADD</a></div>
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div id="variations_data">
                                            <?php if(isset($selected_variation_obj)) : foreach($selected_variation_obj as $k=>$v){ 
                                            ...
                                            <div class="border p-2 sadow m-t-10" style="background: #fbfbfb;" id="variation-<?php echo $variation_id; ?>">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7 col-md-7">Upload image<input type="hidden" name="attr_itemid[]" class="attr_itemid" value="<?= $attribute_item_id ?>">
                                                        <input type="file" name="_thumbnail_id[]" id="_thumbnail_id_<?php echo $k; ?>" class="form-control" value="" <?= ($_thumbnail) ? '' : 'required' ?> data-parsley-filemaxsize="1000" data-parsley-fileextension="jpg|png" parsley-trigger="change" data-parsley-errors-container="#variation_file_error_<?=$attribute_item_id?>">
                                                        <input type="hidden" name="variations_image[]" value="<?= $_thumbnail ?>">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-6 col-md-6"><label for="sale_price" class="col-sm-12 col-form-label">Sale price</label>
