            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header-custom">
                        <h5 class="card-title-custom">Brand List</h5>
                        <div class="topAction-btn" style="display:flex; gap:10px;">
                            <a href="/<?= $TYPE?>/brand/add" class="btn-custom btn-add" title="Add New">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Filter Brand</h5>
                ...
                <form id="filter_data" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <button class="btn btn-primary btn-Submit rounded" type="button"><?= $page_lang->submit; ?></button>
                        </div>
                    </div>
                </form>
            </div>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "/<?= $TYPE; ?>/brand/index_ajax_brand",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            "complete": function () {
        ...
        "columnDefs": [ 
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    // Premium Action Button with Popover
                    ...
                    '<button title="Edit" class="btn custom-popover-btn btn-edit" type="button" data-id="'+row.brand_id+'"><i class="fa fa-pencil-square-o"></i> Edit</button>\''+
...
$(document).on('click','.btn-edit', function(e){
    ...
    // Changed "Update" to "update" below
    var url = "/<?php echo $TYPE ?>/brand/update/" + uid; 
    url_new_tab(e, url);
});
