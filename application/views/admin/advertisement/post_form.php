        ...
        <div class="edit-profile">
            <div class="row ">
                <div class="col-lg-12">
                    ...
                    <?php //echo form_open_multipart("/$TYPE/advertisement/$action/$page_id", array('id' => 'postForm', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'addpost')) ?>
                    
					<form method="post" class="addpost" id="postForm" action='<?php echo "/$TYPE/advertisement/$action/$page_id"; ?>' enctype="multipart/form-data" autocomplete='off'>
					...
					<div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 m-t-20">
                                <div class="card">
                                	...
                                	<?php if(isset($post_title)) { ?><span>Permalink: <a target="_blank" href="<?php echo site_url('/advertisement/').$post_slug; ?>"><?php echo isset($post_slug) ? $post_slug : '' ?></a></span><?php } ?>
                                                </div>
                                                <div class="form-group mb-0">
                                                    <label class="form-label">Body</label>
                                                    <textarea name="post_content" rows="5" class="form-control" placeholder="Write Something..." required><?= isset($post_content) ? $post_content : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
						...
						<?php /*?>	<div class="form-group col-md-4 m-t-20">
...
$(document).on('click','.btn-delete', function(e){
	...
	$.ajax({
			url         :   '<?php echo base_url();?>admin/advertisement/delimg',
			type        :   'post',
