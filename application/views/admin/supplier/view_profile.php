...
<div class="col-md-8">
	<form class="row" action='<?php echo "/$TYPE/supplier/$action/$supplier_id"; ?>' method="post" enctype="multipart/form-data">   
		...
		<div class="form-group col-md-4 m-t-10">
			...
			echo isset($basic->lname) ? $basic->lname : ''; ?>" placeholder="<?= $page_lang->last_name; ?>" > 
		</div>  
		
		<div class="form-group col-md-4 m-t-10">
			<label> <?= $page_lang->address; ?></label>
			<input type="text" class="form-control" name="Address" placeholder="<?= $page_lang->address; ?>"  value="<?php echo isset($basic->address) ?$basic->address : ''; ?>" minlength="10" required> 
		</div>
		<div class="form-group col-md-4 m-t-10">
			<label><?= $page_lang->city; ?></label>
			<input type="text" class="form-control" name="City" placeholder="<?= $page_lang->city; ?>"  value="<?php echo isset($basic->city) ?$basic->city : ''; ?>" minlength="10" placeholder="<?= $page_lang->city; ?>" > 
		</div>
