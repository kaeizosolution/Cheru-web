...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: 700; color: #1e293b;"><?= $page_lang->add_new; ?></h3>
                </div>
                <?= $breadcrumbs ?> 
            </div>
        </div>
        ...
        <div class="edit-profile">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <form method="post" class="card addpost" id="postForm" action='<?php echo "/$TYPE/user/$action/$customer_id"; ?>' enctype="multipart/form-data" autocomplete='off'>
                    
                    <div class="card-header-custom">
                        <h5 class="card-title-custom">Customer Details</h5>
                        <a href="/<?= $TYPE; ?>/user" class="btn-close-card" title="Close"><i class="fa fa-times"></i></a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <?php if(isset($customer_uid)) { ?>
                                        <small class="text-muted mt-1 d-block">ID: <a target="_blank" href="<?php echo site_url('/page/').$customer_uid; ?>"><?php echo isset($customer_uid) ? $customer_uid : '' ?></a></small>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" placeholder="Password" id="password" name="password" value="<?= isset($password) ? $password : '' ?>" required >
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="user_description" rows="4" class="form-control" placeholder="Write Something..."><?= isset($user_description) ? $user_description : '' ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <label for="image_url1" id="img_error" style="display:none; color:red; font-size:12px; margin-top:5px;" generated="true" class="error">Please enter a valid image (max 50kb).</label>
                                
                                <?php $featured_image = isset($featured_image) ? $featured_image : ''; 
                                if($featured_image){ ?>
                                    <div class="mt-2">
                                        <img src="http://klentano.msdev.in/assets/images/<?php echo $featured_image; ?>" width="100" height="100" alt="feature image" class="rounded border p-1" />
                                    </div>
                                <?php } ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="switch-container">
                                    ...
                                    <label class="switch-label"><?= ($status == '1') ? 'Active' : 'Inactive' ?></label>
                                </div>
                                </div>
                    ...
                    <div class="card-footer text-right bg-white border-top p-4" style="border-radius: 0 0 16px 16px;">
                        ...
                        <a href="/<?= $TYPE?>/user" class="btn btn-back-custom">Back</a>
...
$(document).ready(function() {
    $('.select2').select2({allowClear: true, placeholder: "Select Role", width: '100%'});
});
