            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header-custom">
                        <h5 class="card-title-custom">Tax List</h5>
                        <div class="topAction-btn" style="display:flex; gap:10px;">
                            <a href="/<?= $TYPE?>/tax/add" class="btn-custom btn-add" title="Add New">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Filter Tax</h5>
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    if(row.tax_id > 1){
                        ...
                        '<button title="Edit" class="btn custom-popover-btn btn-edit" type="button" data-id="'+row.tax_id+'"><i class="fa fa-pencil-square-o"></i> Edit</button>\''+
