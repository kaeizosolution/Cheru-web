        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <div class="topAction-btn"><a href="/<?= $TYPE?>/categories_prod/add" class="btn btn-primary addNew" title="Add New" data-toggle="tooltip" data-placement="top" data-animation="false"><i class="fa fa-plus"></i></a>
            ...
            <div class="modal-body">
                <div class="col-sm-12 sp-top-30">
                    <form id="filter_data" method="post">
                        <div class="row">                            
                            <div class="col-md-6">
								<label for="city"><?= $page_lang->category_name; ?></label>
