...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6"> <h3><?= $page_lang->cancel_order; ?></h3> </div> <?= $breadcrumbs ?>
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">                        
                        ...
                        <button onclick="window.location.href = '<?php echo base_url();?>admin/order/export_cancel_csv';" type="button" class="btn btn-info"><i class="fa fa-cloud-download"></i><i class="" aria-hidden="true"></i> Export(CSV)</button>					
                    ...
                    <form id="filter_data_filter" method="post">
                        <div class="row">
                            <div class="col-md-6 col s4">
                                ...
                                <input type="text" id="order_uid" name="order_uid" placeholder="<?= $page_lang->order_uid; ?>" class="form-control validate" />
                            </div>
                            <div class="col-md-6 col s4">
                                <label for="city"><?= $page_lang->order_date; ?></label>
                                <input type="text" id="date_created" name="date_created" placeholder="<?= $page_lang->order_date; ?>" class="form-control validate" />
                            </div>
