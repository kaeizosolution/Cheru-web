...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6"> <h3><?= $page_lang->complete_order; ?></h3> </div> <?= $breadcrumbs ?>
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">                        
						...
						<button onclick="window.location.href = '<?php echo base_url();?>admin/order/export_comp_csv';" type="button" class="btn btn-info"><i class="fa fa-cloud-download"></i><i class="" aria-hidden="true"></i> Export(CSV)</button>
                    ...
                    <form id="filter_data_filter" method="post">
                        <div class="row">
                            <div class="col-md-6 col s4">
								<label for="supplier_name"><?= $page_lang->order_uid; ?></label>
                                <input type="text" id="order_uid" name="order_uid" class="form-control validate" placeholder="<?= $page_lang->order_uid; ?>"/>
                            </div>
                            <div class="col-md-6 col s4">
								<label for="city"><?= $page_lang->order_date; ?></label>
                                <input type="text" id="date_created" name="date_created" class="form-control validate" placeholder="<?= $page_lang->order_date; ?>" />
                            </div>
	...
	*/
    ...
    table = $('#table').DataTable({
     ...
     //   "order":[],
        ...
        "ajax": {
            "url": "/<?= $TYPE; ?>/order/ajax-get-complete-order",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            complete: function () {
