...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: 700; color: #1e293b;"><?= $page_lang->subscription; ?></h3>
                </div>
                <?= $breadcrumbs ?>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header-custom">
                        <h5 class="card-title-custom">Subscription List</h5>
                        <div class="topAction-btn" style="display:flex; gap:10px;">
                            <button onclick="window.location.href = '<?php echo base_url();?>admin/subscription/export_csv';" type="button" class="btn-custom btn-export">
                                <i class="fa fa-cloud-download"></i> <?= $page_lang->subscription_report_csv; ?>
                            </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Filter Subscriptions</h5>
...
function dataTable()
{
    ...
    if($('#created').val().trim()) { filterData.created = $('#created').val(); }
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "/<?= $TYPE; ?>/subscription/index_ajax_post",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            "complete": function () {
