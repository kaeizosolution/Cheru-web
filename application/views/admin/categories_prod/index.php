...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6">
                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: 700; color: #1e293b;"><?= $page_lang->categories; ?></h3>
                </div>
                <?= $breadcrumbs ?>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header-custom">
                        <h5 class="card-title-custom">Category List</h5>
                        <div class="topAction-btn" style="display:flex; gap:10px;">
                            <a href="/<?= $TYPE?>/categories_prod/add" class="btn-custom btn-add" title="Add New">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Filter Categories</h5>
                ...
                <form id="filter_data" method="post">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="font-weight-bold text-muted small"><?= $page_lang->category_name; ?></label>
...
function dataTable()
{
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "/<?= $TYPE; ?>/Categories_prod/index_ajax_cat",
            "data": postData,
            "type": "POST",
            "dataType": 'json',
            "complete": function () {
        ...
        "columnDefs": [ 
            {
                ...
                "render": function ( data, type, row ) {
					var st = (typeof row.status !== 'undefined') ? String(row.status) : '';
					if (st === '1' || st.toLowerCase() === 'active') {
						return '<span class="badge-custom badge-active">Active</span>';
					}
					if (typeof row.status_label !== 'undefined') {
						var lbl = String(row.status_label);
						if (lbl.toLowerCase() === 'active') {
							return '<span class="badge-custom badge-active">Active</span>';
						}
					}
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    '<button title="Edit" class="btn custom-popover-btn btn-edit" type="button" data-id="'+row.id+'"><i class="fa fa-pencil-square-o"></i> Edit</button>\''+
...
$(document).on('click','.btn-edit', function(e){
    ...
    var url="/<?php echo $TYPE ?>/categories_prod/update/"+uid+"";
    url_new_tab(e,url);
});
