        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">                       
						<div class="topAction-btn"><a href="/<?= $TYPE?>/banner" class="btn btn-primary addNew" title="Home Page Banner" data-toggle="tooltip" data-placement="top" data-animation="false"><i class="fa fa-eye"></i></a>
                        </div>
