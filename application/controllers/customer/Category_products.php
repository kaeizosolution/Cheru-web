...
class Category_products extends MY_Controller {
    ...
    public function index($slug = null)
    {
        ...
        if (!$api_ok) {
            ...
            $products = $this->db
                ->select('p.id, p.name, p.product_type, p.status, p.category')
                ->from('products p')
                ...
                ->group_end()
                ->group_start()
                    ->where('p.category', (string)($category->name ?? ''))
                    ->or_where('p.category', (string)$slug)
