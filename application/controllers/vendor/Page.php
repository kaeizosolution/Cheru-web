...
class Page extends MY_Controller {
	...
	function post($page_id = NULL)
    {
        ...
        if(isset($page_id)){
			...
			if($_POST) {
				...
				$db_data =  array(
						...
						'post_title_es'     => $this->input->post('post_title_es'),
						'post_slug'         => $this->input->post('post_slug'),
						'post_content'  	=> $this->input->post('post_content'),
						'post_content_es'  	=> $this->input->post('post_content_es'),
		...
		if( isset($_FILES['featured_image']['name']) && !empty($_FILES['featured_image']['name'])){
			...
			$db_data =  array(
				...
				'post_slug'        => get_slug( $data['post_title'] ),
	...
	public function export_csv(){ 
	   ...
	   // file creation  
		...
		$header = array("page_id","post_title","post_title_es","post_content","post_content_es","created");   
