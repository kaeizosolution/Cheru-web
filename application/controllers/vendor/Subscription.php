...
class Subscription extends MY_Controller {
    ...
    {	
        ...
        $output = array(
            ...
            "recordsTotal" => $this->Subscription_model->count_all('ec_enquiry'),
            "recordsFiltered" => $this->Subscription_model->count_filtered('ec_enquiry'),
            "data" => $data,
        );
	...
	public function export_csv(){ 
	   ...
	   // file creation  
		...
		$header = array("enquiry_id","fname","lname","email","message","custype","ip_address","created");   
