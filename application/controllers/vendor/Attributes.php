        ...
        foreach ($list as $obj) {
            ...
            if($item_obj){
                foreach($item_obj as $it){
                    $item_str.= "<a href=\"/vendor/attributes/update_attribute_item/$obj->attribute_id/$it->attribute_item_id\" target=\"_blank\">$it->name</a>&nbsp;&nbsp;";
                }
            }
            $item_str.= "<br><a href=\"/vendor/attributes/add_attribute_item/$obj->attribute_id\" target=\"_blank\"  class=\"table_btn_add\">Add</a>";
