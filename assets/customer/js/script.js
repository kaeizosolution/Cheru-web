(function($) {
    ...
    $(function() {
      (function quantityProducts() {
        ...
        $quantityArrowMinus.off('click.qtyp').on('click.qtyp', quantityMinus);
        $quantityArrowPlus.off('click.qtyp').on('click.qtyp', quantityPlus);
        function getScopedQtyInput(btn) {
          var $btn = $(btn);
          var $wrap = $btn.closest('.quantity-block');
          if ($wrap.length) {
            var $input = $wrap.find('.quantity-num').first();
            if ($input.length) return $input;
          }
          return $btn.siblings('.quantity-num').first();
        }
        function quantityMinus(e) {
          if ($(this).hasClass('quantity_update') || typeof $(this).data('product_id') !== 'undefined') {
            return;
          }
          var $quantityNum = getScopedQtyInput(this);
          if ($quantityNum && $quantityNum.length && Number($quantityNum.val() || 0) > 1) {
            $quantityNum.val(+($quantityNum.val() || 0) - 1);
          }
        }
        function quantityPlus(e) {
          ...
          var $quantityNum = getScopedQtyInput(this);
          if ($quantityNum && $quantityNum.length) {
            $quantityNum.val(+($quantityNum.val() || 0) + 1);
          }
        }
      })();
    ...
    $(function() {
      (function quantityProducts() {
        ...
        $quantityArrowMinus.off('click.qtyp2').on('click.qtyp2', quantityMinus);
        $quantityArrowPlus.off('click.qtyp2').on('click.qtyp2', quantityPlus);
        function getScopedQtyInput(btn) {
          var $btn = $(btn);
          var $wrap = $btn.closest('.quantity-block');
          if ($wrap.length) {
            var $input = $wrap.find('.quantity-num2').first();
            if ($input.length) return $input;
          }
          return $btn.siblings('.quantity-num2').first();
        }
        function quantityMinus(e) {
          if ($(this).hasClass('quantity_update') || typeof $(this).data('product_id') !== 'undefined') {
            return;
    ...
    $(function() {
      (function quantityProducts() {
        ...
        $quantityArrowMinus.off('click.qtyp3').on('click.qtyp3', quantityMinus);
        $quantityArrowPlus.off('click.qtyp3').on('click.qtyp3', quantityPlus);
        function getScopedQtyInput(btn) {
          var $btn = $(btn);
          var $wrap = $btn.closest('.quantity-block');
          if ($wrap.length) {
            var $input = $wrap.find('.quantity-num3').first();
            if ($input.length) return $input;
          }
          return $btn.siblings('.quantity-num3').first();
        }
        function quantityMinus(e) {
          if ($(this).hasClass('quantity_update') || typeof $(this).data('product_id') !== 'undefined') {
            return;
