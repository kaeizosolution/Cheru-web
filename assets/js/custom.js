...
$(function() {
	...
	Accordion.prototype.dropdown = function(e) {
		...
		$next.slideToggle();
		$this.parent().toggleClass('opensecond');

		if (!e.data.multiple) {
			$el.find('.submenu').not($next).slideUp().parent().removeClass('opensecond');
		};
	}	
...
$(function() {
	...
	var accordion2 = new Accordion($('#accordion-subcategory-three'), false);
});
